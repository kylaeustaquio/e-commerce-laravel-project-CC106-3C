    ...
    <header>
      <div class="section__container header__container">
        ...
        <div class="header__image">
          <img src="<?php echo e(asset('img/img/logo.jpg')); ?>" />
      ...
      <div class="arrival__grid">
        <div class="arrival__card">
          <div class="arrival__image">
            ...
            <img src="<?php echo e(asset('img/img/newarraival1.jpg')); ?>" />
          </div>
        ...
        <div class="arrival__card">
          <div class="arrival__image">
            ...
            <img src="<?php echo e(asset('img/img/newarraival2.jpg')); ?>" />
          </div>
          <div class="arrival__content">
            <div>
        ...
        <div class="arrival__card">
          <div class="arrival__image">
            ...
            <img src="<?php echo e(asset('img/img/newarraival3.jpg')); ?>" />
          </div>
          <div class="arrival__content">
            <div>
              <h4>Fasion</h4>
      ...
      <div class="favourite__grid">
        <div class="favourite__card">
          <div class="favourite__image">
           ...
           <img src="<?php echo e(asset('img/img/favourite1.jpg')); ?>" />
          </div>
        ...
        <div class="favourite__card">
          <div class="favourite__image">
            ...
            <img src="<?php echo e(asset('img/img/favourite2.jpg')); ?>" />
          </div>
          <div class="favourite__content">
            <div>
              <h4>Trending Online</h4>
...
<?php /**PATH C:\Users\Kyla\Herd\e-commerceproject\resources\views/livewire/homepage.blade.php ENDPATH**/ ?>